...
#include <memory>
#include "../Hospital_Terminal/database_manager.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DatabaseManager_t, stringdata0) + ofs), len 
...
const QMetaObject DatabaseManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_DatabaseManager.offsetsAndSize,
